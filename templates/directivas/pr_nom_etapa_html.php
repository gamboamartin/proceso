...
use gamboamartin\proceso\controllers\controlador_pr_nom_etapa;
...
class pr_nom_etapa_html extends html_controler {
    ...
    private function asigna_inputs(controlador_pr_nom_etapa $controler, stdClass $inputs): array|stdClass
    {
    ...
    public function genera_inputs_alta(controlador_pr_nom_etapa $controler, PDO $link): array|stdClass
    {
    ...
    private function genera_inputs_modifica(controlador_pr_nom_etapa $controler,PDO $link,
    ...
    public function inputs_pr_etapa_proceso(controlador_pr_nom_etapa $controlador,
                                            stdClass $params = new stdClass()): array|stdClass
    {
