...
class controlador_pr_proceso extends _ctl_base {
    ...
    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(),
        ...
        $datatables->columns['pr_proceso_codigo']['titulo'] = 'Cod';
        $datatables->columns['pr_proceso_descripcion']['titulo'] = 'Proceso';
        $datatables->columns['pr_tipo_proceso_descripcion']['titulo'] = 'Proceso';
    ...
    protected function key_selects_txt(array $keys_selects): array
    {
        ...
        $keys_selects = (new \base\controller\init())->key_select_txt(cols: 6,key: 'descripcion', keys_selects:$keys_selects, place_holder: 'Proceso');
        if(errores::$error){
            return $this->errores->error(mensaje: 'Error al maquetar key_selects',data:  $keys_selects);
        }
        return $keys_selects;
